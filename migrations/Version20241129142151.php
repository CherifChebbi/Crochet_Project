 ...
 */
final class Version20241129142151 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE product (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) DEFAULT NULL, color VARCHAR(255) DEFAULT NULL, size VARCHAR(255) DEFAULT NULL, type VARCHAR(255) DEFAULT NULL, price NUMERIC(10, 2) DEFAULT NULL, availability TINYINT(1) DEFAULT NULL, description LONGTEXT DEFAULT NULL, nbr_media INT DEFAULT 0 NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
